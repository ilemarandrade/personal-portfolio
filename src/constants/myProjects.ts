...
const myProjects: IProject[] = [
  {
    name: "Eventezer Admin",
    slug: "eventezer-admin",
  ...
  {
    name: "Eventezer Services",
    slug: "eventezer-services",
    link: "/works/eventezer-services",
    environment: "NODE JS API",
    category: ProjectCategory.production,
    description: ["projects.eventezer_services.first_paragraph"],
    isMarkdown: true,
    dependencies: [
      {
        environment: "Backend",
